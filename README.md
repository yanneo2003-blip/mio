...
✨ 核心特性
🌌 双核排盘引擎：集成 lunar-javascript 与 iztro，支持精确到真太阳时的八字排盘与紫微斗数排盘。内置中国主要城市经纬度数据，自动校正出生时间偏差。

🎭 多维 AI 人格矩阵：内置 7 位风格迥异的咨询师人格，包括道家高人、盲派宗师、现代心理学家、纵横家等。支持**“诸仙会审”**模式，让不同流派的 AI 大师为您联合推演，从不同角度辩证分析。
...
🤝 贡献欢迎提交 Issue 或 Pull Request！由于本项目保持“单文件”特性以便于分发，请尽量保持代码的紧凑性。

📄 许可证本项目采用 MIT License 开源。<div align="center"> Designed with ❤️ by Mio </div>
